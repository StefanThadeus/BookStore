...
<form method="post" action="<?php echo $baseURL; ?>books/createNewBook" class="shadow-sm p-4 mb-6 form-background">
    ...
    <div class="form-group">
        <label>Year</label>
        <input type="text" class="form-control" name="year" placeholder="Enter book release year">
    </div>
